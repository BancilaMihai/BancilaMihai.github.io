...
func citeste(a: inout Float,b: inout Float,c: inout Float){ //a: inout Float-referinta-valorile modif se transmit in afara, a:Float -asa nu era bine, era prin copiere
    print("a= ")
    let s_opt=readLine()
    if let s=s_opt{
        let a_opt=Float(s)
...
var a,b,c:Float //var a b c de tip float
a=0
b=0
c=0
...
x1_im=0
x2_im=0
citeste(a:&a,b:&b,c:&c)//la a ii dam valoarea variabilei a -&a s-a transmis prin referinta
